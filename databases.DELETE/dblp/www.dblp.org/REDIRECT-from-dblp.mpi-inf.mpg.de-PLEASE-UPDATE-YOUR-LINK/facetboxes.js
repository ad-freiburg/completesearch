...
function showFacetBoxes(boxes) 
{
    ...
    link.href = "http://www.dblp.org/search/index.php#query=" + authorQuery;
    ...
    form.action = "http://www.dblp.org/search/relay.php";
...
function getFacetBoxes() 
{
  ...
  if (xmlhttp) {
      ...
      if (window.ActiveXObject || (navigator.appVersion.search("Chrome") != -1)) { url = unescape(encodeURIComponent(url)); }
