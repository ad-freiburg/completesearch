...
<body bgcolor="#ffffff" text="#000000" link="#000000" onload="init();">
  ...
  <!-- Print notes in case javascript or cookies are disabled. -->
  <?php #if (!$AC->cookies) echo "<hr/><b>".$AC->get_text("cookie_note")."</b>";?>
  <noscript>
    <?php echo (!$AC->cookies ? "<br>" : "<hr/>") . "<b>".$AC->get_text("javascript_note")."</b>"; ?>
  </noscript>
