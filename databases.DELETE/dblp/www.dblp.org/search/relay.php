<?php
  ...
  // NEW 10May12 (Ina):
  // We need to decode the string and remove all html/php-entities by using strip_tags to get a proper url. This solution doesn't work
  // with special characters. But I haven't found a solution, which works with special characters.
  if (isset($_SERVER["QUERY_STRING"]) && $_SERVER["QUERY_STRING"] != "") $path_info .=  "#" . strip_tags(rawurldecode($_SERVER["QUERY_STRING"]));
