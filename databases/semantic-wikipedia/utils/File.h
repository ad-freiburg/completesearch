...
#ifndef SEMANTIC_WIKIPEDIA_UTILS_FILE_H_
#define SEMANTIC_WIKIPEDIA_UTILS_FILE_H_
  ...
  public:
    ...
    bool readLine(string* line, char* buf, size_t bufferSize)
    {
      ...
      else if (retVal && !isAtEof())
      {
        ...
        SEM_THROW(ad_semsearch::Exception::INVALID_PARAMETER_VALUE,
...
#endif  // SEMANTIC_WIKIPEDIA_UTILS_FILE_H_
