...
class MyListener implements PHPUnit_Framework_TestListener
{
  ...
  // Markus / 30-09-08: nicht elegant, unter Umgehung der dafür vorgesehenen Klassen
...
//    echo "\nSummary:";
  ...
  {
    // Markus / 30-09-08: nicht elegant, unter Umgehung der dafür vorgesehenen Klassen
    $okCount = count($result) - $result->errorCount() - $result->failureCount() - $this->incompleteCount - $this->skippedCount;
//    $okCount = count($result) - $result->errorCount() - $result->failureCount();
    ...
    // Markus / 30-09-08: nicht elegant, unter Umgehung der dafür vorgesehenen Klassen
    $this->write(", " . $this->incompleteCount . " incomplete");
    $this->write(", " . $this->skippedCount . " skipped");
    /*
  ...
  // Markus: to add comment to the test summary line in the log file from inside the tests
  public function addComment($text)
  {
    $this->summaryLine .= $text;
  }
