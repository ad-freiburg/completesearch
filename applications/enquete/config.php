...
$config->application_name = "default";

// The title of the main page (used for the HTML title-tag)
$config->html_title = "CompleteSearch Enquete-Bericht";
...
// $config->server_hostname = "vulcano.informatik.privat";
$config->server_hostname = "filicudi.informatik.uni-freiburg.de";
// $config->server_hostname = "ad-research.informatik.uni-freiburg.de";
...
$config->delays = array(100, 100, 50);
...
$config->top_hits = array(10, 50, 250, 1000);
...
$config->hits_per_page_while_typing = 20;

// Number of hits per page on click or return.
$config->hits_per_page_on_click = 1000;
...
$config->user_preferences = array("max_completions_show_right", 
                                  "query_types", 
                                  "hits_per_page_while_typing", 
                                  "hits_per_page_on_click", 
...
$config->hit_template = "<p class='title'>%BERICHTSTEIL% &mdash; %ABSCHNITT%</p>" .
